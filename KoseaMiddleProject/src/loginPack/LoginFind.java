...
public class LoginFind extends JDialog {
	...
	public LoginFind() {
		...
		JLabel nameLabel = new JLabel("¼º¸í  :");
		...
		JLabel phoneLabel = new JLabel("¿¬¶ôÃ³  :");
		...
		idFindB.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				if(!nameF.getText().isBlank() && !phoneF1.getText().isBlank() && !phoneF2.getText().isBlank() && !phoneF3.getText().isBlank() && !shopF.getText().isBlank()) {
