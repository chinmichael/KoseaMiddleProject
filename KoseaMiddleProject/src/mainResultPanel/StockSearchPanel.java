	...
	public StockSearchPanel() {
		...
		searchB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ArrayList<SearchStockDB> list = ssq.list(shopID, code, name, brand, type, type2, check);
				
				if(ssq.getFlg()) {
					StockSearchPop ssp = new StockSearchPop();
					ssp.openList(list);
					ssq.setFlg(false);
		...
		JLabel lblNewLabel_1 = new JLabel("재고 상품명 :   ");
		lblNewLabel_1.setForeground(new Color(102, 51, 0));
		lblNewLabel_1.setFont(new Font("굴림", Font.BOLD, 15));
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.RIGHT);
		lblNewLabel_1.setBounds(12, 85, 126, 27);
		add(lblNewLabel_1);
